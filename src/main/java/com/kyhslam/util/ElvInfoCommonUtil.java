...
public class ElvInfoCommonUtil {
    ...
    //api용 특정호기의 영업사양 정보 조회
    public static ArrayList<ElvInfoDTO> findElvInfoList(String hogi) {
        Connection con 			= null;
        PreparedStatement pstmt = null;
        ResultSet rs 			= null;
        ...
        try {
            ...
            String sql = """        
                     ...
                     V.EL_ECBG, --CAR:BG 
                     V.EL_ECEE, --CAR 무게중심;EE 
                     V.EL_ECAA, --CAR 외부가로 ; AA      
                     V.EL_ECBB, --CAR 외부세로 ; BB      
                     V.EL_ECCA, --CAR 내부가로 ; CA      
                     V.EL_ECCB, --CAR 내부세로 ; CB
                     V.EL_ECJJ, --도어폭;JJ       
                     V.EL_ECDOP, --◎ CAR DOOR OPER
                     V.EL_ERPW, -- ROPE/BELT; 본수
                     COD(V.EL_ECWRL) AS EL_ECWRL, --CWT RAIL(K) 
                     COD(V.EL_ETM) AS EL_ETM, --권상기 
                     V.EL_ECWBG AS EL_ECWBG, --CWT; BG 
                     V.EL_ECWW AS EL_ECWW, --CWT;폭 
                     ...
                     COD(V.EL_BWALLT) AS EL_BWALLT, --WALL구조 
                     COD(V.EL_BCLCDL) AS EL_BCLCDL, --    LCD;취부위치 
                     COD(V.EL_BMOPB) AS EL_BMOPB, -- MAIN OPB사양
                     COD(V.EL_BETM) AS EL_BETM, --TRANSOM 재질/무늬 
                     COD(V.EL_BOPBSWD) AS EL_BOPBSWD, --  OPB;SWING&WIDE
                     V.EL_AFQ, --층수, 
                     V.EL_EHTRH,--주행거리 
                     V.EL_EHV, -- 승강로 세로;YY 
                     V.EL_ZTEXT_B, --가내 특기사항 
