...
public class SendMail {
    ...
    public static void sendChinaPart(ArrayList<PartInfoDTO> data) {
        ...
        String toEmail = "younghwan.kim@hyundaielevator.com, jihyun.kim@hyundaielevator.com, jeongwon.shon@hyundaielevator.com, dongki.seo@hyundaielevator.com, hh.park@hyundaielevator.com, sunwoo.jung@hyundaielevator.com, daehwan.ahn@hyundaielevator.com, seonuk.lee@hyundaielevator.com";
