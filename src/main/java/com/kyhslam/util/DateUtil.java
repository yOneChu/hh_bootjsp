...
/**
 * 날짜 관련 유틸리티 클래스
 * Date utility class for handling date operations
 */
public class DateUtil {
     ...
     * 
     * @return String 오늘 날짜 (Today's date)
     */
     ...
     * @return String 오늘 날짜 (Today's date)
     */
    public static String getTodayDateNoHyphen() {
        LocalDate today = LocalDate.now();
     ...
     * 
     * @return String 오늘 날짜와 시간 (Today's date and time)
     */
    ...
    /**
     * 오늘 날짜와 시간을 "yyyyMMddHHmmss" 형식으로 반환
     * Returns today's date and time in "yyyyMMddHHmmss" format
     * 
     * @return String 오늘 날짜와 시간 (Today's date and time)
     */
    public static String getTodayDateTimeNoSeparator() {
        LocalDateTime now = LocalDateTime.now();
     ...
     * 
     * @param format 날짜 형식 (Date format)
     * @return String 지정된 형식의 오늘 날짜 (Today's date in the specified format)
     */
    ...
    /**
     * java.util.Date를 사용하여 오늘 날짜를 "yyyy-MM-dd" 형식으로 반환
     * Returns today's date in "yyyy-MM-dd" format using java.util.Date
     * 
     * @return String 오늘 날짜 (Today's date)
     */
    public static String getTodayDateUsingLegacyDate() {
        Date today = new Date();
     ...
     * Returns today's date in "yyyy년 MM월 dd일" format
     * 
     * @return String 오늘 날짜 (Today's date)
     */
    public static String getTodayDateKorean() {
        LocalDate today = LocalDate.now();
    ...
    /**
     * 특정 날짜 기준으로 영업일만 7일 출력하는 함수(이전날짜)
