...
<nav class="navbar navbar-expand-lg navbar-custom">
    <div class="container">
        <div class="navbar-brand text-white fw-bold fs-4">
            <i class="bi bi-building me-2"></i>PLM Dashboard
        </div>
        <div class="navbar-nav ms-auto">
            <a class="nav-link text-white" href="#"><i class="bi bi-person-circle me-1"></i>관리자</a>
        </div>
    </div>
</nav>
    ...
    <div class="container">
        <div class="header-content">
            <nav aria-label="breadcrumb">
                <ol class="breadcrumb breadcrumb-hyundai">
                    <li class="breadcrumb-item">홈</li>
                    <li class="breadcrumb-item">PLM 시스템</li>
                    <li class="breadcrumb-item active">자재 사용빈도 분석</li>
                </ol>
            </nav>
            <div class="row align-items-center">
                <div class="col-lg-8">
                    <h1 class="display-5 fw-bold mb-2">자재 사용빈도 분석</h1>
                    <p class="lead mb-0 opacity-90">실시간 자재 사용 현황 및 효율성 분석 대시보드</p>
                </div>
    ...
    <div class="filter-section-hyundai">
        <div class="row g-3 align-items-center">
            <div class="col-md-3">
                ...
                <input type="text" class="form-control form-control-hyundai" placeholder="자재 코드 또는 명칭">
            </div>
            <div class="col-md-2">
