        ...
        String htmlContent = """
                ...
                <body style="font-family: Arial, sans-serif; line-height: 1.6;">
                    ...
                    <table style="border-collapse: collapse; width: 100%;">
                        <thead>
                            <tr>
                                <th style="border: 1px solid #ccc; padding: 8px; background-color: #f2f2f2;">이름</th>
                                <th style="border: 1px solid #ccc; padding: 8px; background-color: #f2f2f2;">담당</th>
                                <th style="border: 1px solid #ccc; padding: 8px; background-color: #f2f2f2;">이메일</th>
                            </tr>
                        </thead>
                        <tbody>
                            <tr>
                            ...
                            <tr>
                                <td style="border: 1px solid #ccc; padding: 8px;">최성준</td>
                                <td style="border: 1px solid #ccc; padding: 8px;">3D 담당</td>
                                <td style="border: 1px solid #ccc; padding: 8px;">hong.gd@yourcompany.com</td>
                            </tr>
                            <tr>
                                <td style="border: 1px solid #ccc; padding: 8px;">김영환</td>
                            ...
                            <tr>
                                <td style="border: 1px solid #ccc; padding: 8px;">최성준</td>
                                <td style="border: 1px solid #ccc; padding: 8px;">3D 담당</td>
                                <td style="border: 1px solid #ccc; padding: 8px;">lee.sy@yourcompany.com</td>
                            </tr>
                        </tbody>
                    </table>
